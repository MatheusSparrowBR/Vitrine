alter table public.businesses
  add column if not exists search_featured boolean not null default false;

create index if not exists businesses_city_search_featured_idx
  on public.businesses(city_id, search_featured, featured, created_at desc);
