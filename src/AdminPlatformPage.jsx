...
export default function AdminPlatformPage({supabase}){
 ...
 const titles={promotions:['Promoções','Crie, agende e gerencie ofertas com horário local, imagem e controle de publicação.'],cities:['Cidades','Gerencie as cidades atendidas pela plataforma.'],categories:['Categorias','Organize a descoberta de empresas e serviços.'],plans:['Planos','Edite preços, descrições e benefícios diretamente pelo painel.'],assignments:['Planos por empresa','Conceda Pro ou Premium manualmente, defina validade e acompanhe o plano efetivo de cada empresa.'],events:['Eventos','Cadastre e modere a agenda pública da cidade.']}
