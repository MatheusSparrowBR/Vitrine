...
export default function DemoPage(){
 ...
 return <main className="demo-shell">
  ...
  <div className="demo-stage" onClick={navigateDemo}>
   ...
   {tab==="businesses"&&<DemoBusinesses businesses={businesses} categories={categories} city={city}/>}
...
function DemoBusinesses({businesses,categories,city}){
...
function DemoAccount({businesses,selected,onSelect,photos,items,promotions,plan,section,setSection}){
 useEffect(()=>{window.__vlDemoSelectBusiness=id=>onSelect(id);return()=>{delete window.__vlDemoSelectBusiness}},[onSelect])
