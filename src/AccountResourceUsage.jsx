...
export default function AccountResourceUsage({businessId,resource,used:legacyUsed=0,onState,onAction,actionLabel='Adicionar'}){
 ...
 useEffect(()=>{if(!usage)return;onState?.({used:usedCount,limit:safeLimit,reached,percent,planCode:usage.planCode||'free',planName,cycleStart:usage.cycleStart||null,cycleEnd:usage.cycleEnd||null})},[usage,usedCount,safeLimit,reached,percent,onState,planName])
