...
function App(){const path=normalizePath(location.pathname),isAdmin=path.startsWith('/admin'),isStandalone=path==='/conta/onboarding',isPrelaunchPlans=path==='/em-breve/planos',isPreviewHome=path==='/preview-lancamento',isLaunchHome=path==='/'||path==='/laguna';return <AppErrorBoundary><AccountModerationGuard><><PrelaunchGate path={path}>{!isAdmin&&!isStandalone&&!isPrelaunchPlans&&!isPreviewHome&&!isLaunchHome&&<SiteHeader/>}{!isAdmin&&!isStandalone&&!isPrelaunchPlans&&<AnalyticsTracker/>}<RootRoute/></PrelaunchGate></></AccountModerationGuard></AppErrorBoundary>}
