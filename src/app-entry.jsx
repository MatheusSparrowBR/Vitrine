...
import DemoAccountPage from './DemoAccountPage.jsx'
...
import CommercialDemoPage from './CommercialDemoPage.jsx'
import './core.css'
import './events.css'
...
function getCityRoute(path){
 ...
 if(p.length===1&&!['login','planos','conta','admin','privacidade','termos','atualizar-senha','usuario','demo'].includes(p[0].toLowerCase()))return {kind:'home',citySlug:p[0].toLowerCase()}
