...
function App(){const path=normalizePath(location.pathname),isAdmin=path.startsWith('/admin'),isStandalone=path==='/conta/onboarding';return <AppErrorBoundary><AccountModerationGuard><><PrelaunchGate path={path}>{!isAdmin&&!isStandalone&&<SiteHeader/>}{!isAdmin&&!isStandalone&&<AnalyticsTracker/>}<RootRoute/></PrelaunchGate></></AccountModerationGuard></AppErrorBoundary>}
