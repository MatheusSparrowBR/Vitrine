...
export default function ModernBusinessesPage({citySlug='laguna'}){
 const[city,setCity]=useState(null),[businesses,setBusinesses]=useState([]),[categories,setCategories]=useState([]),[ratings,setRatings]=useState({}),[cat,setCat]=useState(''),[q,setQ]=useState(''),[loading,setLoading]=useState(true)
