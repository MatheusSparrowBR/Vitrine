...
test('entrypoint usa somente a nova árvore de frontend',()=>{
 ...
 for(const token of ['CityHomePage','BusinessesPage','PromotionsPage','BusinessProfilePage','AccountPage','AdminHomePage','AuthPage','BillingPlansPage','PrivacyPage','TermsPage'])assert.match(app,new RegExp(token))
